...
| Read-only host preflight | Passed with native-host reservations | The [2026-09-21 renewal](../tests/results/2026-09-21-host-preflight.json) binds the unchanged 0.1.1 core skill and manifests plus the validator updated for independently versioned companion skills. Skill Creator and Plugin Creator validators passed; native Cursor/Claude surfaces remain unavailable and `release_qualified` remains `false`. The [previous receipt](../tests/results/2026-09-18-host-preflight.json) is preserved as history |
